...
app.controller("statistical-revenue-ctrl", function ($scope, $http) {
  ...
  $scope.exportDay = function () {
    var d = new Date();
    var url =
      "/rest/statistical/revenue/export/day/" +
      (d.getMonth() + 1) +
      "/" +
      d.getFullYear();
    window.location = url;
  ...
  $scope.exportMonth = function () {
    var d = new Date();
    var url = "/rest/statistical/revenue/export/month/" + d.getFullYear();
    window.location = url;
  };
  $scope.exportYear = function () {
    var d = new Date();
    var url = "/rest/statistical/revenue/export/year/" + d.getFullYear();
    window.location = url;
  };
